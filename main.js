function add(){
    ...
    let options = { year: 'numeric', month: 'long', day: 'numeric' }; // Customize this as needed
    let formattedDate = obj.toLocaleDateString('en-US', options);
    ...
    img.addEventListener("click", function(){
        let a =confirm("Do you really want to delete this?");
        if(a)
            {
                div.remove();
            }
